...
const Cards = () => {
  return (
    <div className='max-w-7xl flex flex-col items-center text-gray-800  gap-4 font-mont mb-4 mx-auto mt-3'>
        <h1 className='w-full flex text-[30px] md:text-[48px] font-medium items-center justify-center md:items-start md:justify-start'>Case Studies</h1>
