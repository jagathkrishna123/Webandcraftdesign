...
// import Uaeimg from "../assets/uaeeimage.jpg"
...
//           {/* left.......*/}
//           <div className="flex flex-col space-y-4">
//             <img src={Uaeimg} alt="India Gate" className="rounded-md w-full h-52 object-cover"/>
//             <div className="flex items-center space-x-2">
//               <img src={UaeFlag} alt="India Flag" className="w-6 h-4" />
